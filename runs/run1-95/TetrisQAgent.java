    ...
    extends QAgent
{
                                    ...
                                    final Mino potentialAction)
    {
        try
        {
            ...
            // Check bottoms, regardless of orientation
            for (int x = 0; x < c; x++) {
                if (board.get(r - 1, x) == 1) {
                    snugness +=2;
                }
            }

            // Determine the total number of features:
            int totalFeatures = 4; // 5 with snugness
   ...
   /**
    ...
    public double getReward(final GameView game)
    {
        ...
        score += (scoreThisTurn*50); // score earned from placing previous mino
