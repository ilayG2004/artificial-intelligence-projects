...
public class StealthAgent
    ...
    public Map<Integer, Action> middleStep(StateView state,
        ...
        /**
         * I would suggest implementing a state machine here to calculate a path when
         * neccessary.
         ...
         * }
         * 
         * then after this, worry about how you will follow this path by submitting
         * sepia actions
         * the trouble is that we don't want to move on from a point on the path until
         * we reach it
         * so be sure to take that into account in your design
         * 
         * once you have this working I would worry about trying to detect when you kill
         * the townhall
    ...
    public Path aStarSearch(Vertex src,
            ...
            ExtraParams extraParams) {
        // Big function
        // Based off dijkstra's psuedocode maybe?
        // Call a bunch on middle step
        return null;
    }
    ...
    public float getEdgeWeight(Vertex src,
        ...
        // Called in A*
        // Our heuristic
        // Something towards townhall costs less, away costs more (use manhattan
        // distance)
        // Towards enemy or whatever costs more, away costs less
        // Private variable that states if we have killed the townhall, picked up the
        // gold
        return 1f;
    }
